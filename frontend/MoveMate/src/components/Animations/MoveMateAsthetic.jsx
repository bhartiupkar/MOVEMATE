    ...
    <div className={classStyle ? classStyle : "w-full flex justify-center items-center  bg-slate-100"}>
      ...
      >
        <div className="flex flex-col items-center justify-center min-h-screen  text-center">
          <motion.span
            className="block text-9xl font-extrabold bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-400 bg-[length:200%_200%] bg-clip-text text-transparent animate-gradient-shimmer"
          ...
          <motion.span
            className="block text-9xl font-extrabold bg-gradient-to-r from-yellow-300 via-green-400 to-blue-500 bg-[length:200%_200%] bg-clip-text text-transparent animate-gradient-shimmer"
            initial={{ opacity: 0, scale: 0.9, x: 30 }}
            animate={{ opacity: 1, scale: 1.1, x: 0 }}
            transition={{
              duration: 2,

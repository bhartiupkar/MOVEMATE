            ...
            <div className={`relative flex flex-col bg-white shadow-lg rounded-lg overflow-hidden`}>
                ...
                {!hideHeader && (
                    <div className='flex items-center justify-between p-4 border-b border-gray-200 '>
                        <h3 className='mg:text-lg font-medium text-gray-900 '>
                            {title}
                        </h3>
                        {showActionBtn && (
                ...
                <button
                    ...
                    >
                        <path
                            ...
                            strokeWidth='2'
                            d='M1 1l12 12M13 1L1 13' // Two diagonal lines forming an "X"
                        />
                    </svg>
                ...
                <div className='flex-l overflow-y-auto custom-scrollbar'>{children}

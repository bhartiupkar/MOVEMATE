    ...
    return (<>
        ...
        {dataToShow.length === 0 ? (<>
            ...
            <>
                ...
                <motion.div
                    className="flex flex-col  px-6 py-10 gap-5  border-1 cursor-pointer max-h-screen p-4 shadow-2xl text-black bg-slate-100  overflow-y-auto  rounded-3xl scrollbar-hide my-10 "
                >

...
const SearchProduct = () => {
    ...
    return (
        <motion.div className="sm:flex md:flex min-h-screen mb-[10%] w-screen bg-gray-50 ">
            {/* Left side - Form (1/3) */}
            <motion.div
                ...
                className="md:w-1/3 border-12 border-gray-400   p-10 flex flex-col justify-center gap-4 bg-gray-950/80  mx-4 my-10  rounded-[40px] shadow-[0_-4px_12px_rgba(1,1,1,0.15)] max-h-screen hover:bg-gray-900/80">
